...
We can `filter` for only professions with 5 or more observations.

.panelset[
.panel[.panel-name[Plot]
```{r, professions-2-out, ref.label="professions-2", echo=FALSE, warning=FALSE, fig.width = 8, fig.asp = 0.618, dev = "svg"}
